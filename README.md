...
2. In the repo on GitHub: **Settings → Secrets and variables → Actions**, add **`POSTMAN_API_KEY`** (required) — API key for the Postman service account that is allowed to call the mint endpoint and onboarding APIs.
